...
def check_best_config():
    feature_extraction_config = {
                ...
                'best_representing_words_list': ['vocabularies/fast_rank_best_words_custom.txt',
                                                 'vocabularies/fast_rank_best_words_10.txt'],
...
def train_model_for_debug():
    ...
    train_model.test_model(clf, data, target, original_text, 'fast_rank_mistakes.csv', verbose=True)
